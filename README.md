...
<img src="https://github.com/azmawee.png?size=280" width="140" height="140" alt="Azmawee">
...
- **Keselamatan emel:** DMARC, SPF, DKIM, Exchange filtering
- **Infra & pemantauan:** HP OpenView (OVO, OVIS), Nagios, load balancing, CDN, Cloud WAF (AWS, Alibaba Cloud)
...
- Skrip dan dokumentasi teknikal di blog peribadi: [azmawee.freebsd.my](https://azmawee.freebsd.my):
  ...
  - Dokumentasi: fiber Maxis, BIND, MPD5, Squid delay pool
...
| [**DMARC_SPF_Changes_Check**](https://github.com/azmawee/DMARC_SPF_Changes_Check) | Pantau perubahan rekod **DMARC dan SPF** untuk domain. | Shell |
